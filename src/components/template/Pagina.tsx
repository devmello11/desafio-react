...
export default function Pagina(props: PaginaProps){
    ...
    return (
        <div className="flex h-screen">
            ...
            <button
                className="fixed top-4 left-4 z-50 md:hidden bg-indigo-700 hover:bg-indigo-800 text-white rounded-full p-2 shadow-lg focus:outline-none focus:ring-2 focus:ring-indigo-400"
